...
export function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-border/60 px-4 glass bg-white">
      ...
      <div className="flex items-center gap-2">
        ...
        <Button variant="outline" size="sm" className="rounded-xl border-gray-200 bg-white shadow-sm" onClick={handleLogout}>
          Logout
        </Button>
      </div>
    </header>
