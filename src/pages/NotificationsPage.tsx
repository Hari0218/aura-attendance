          ...
          <Card className="border-border/50 lg:col-span-1">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label>Type</Label>
                <Select>
                  <SelectTrigger><SelectValue placeholder="Notification type" /></SelectTrigger>
                  <SelectContent>
              ...
              <Button className="w-full gradient-primary text-primary-foreground border-0" onClick={() => toast({ title: "Notification Sent" })}>
              ...
              <Table>
                ...
                <TableBody>
                  {mockNotifications.map((n) => {
                    ...
                    return (
                      <TableRow key={n.id}>
                        <TableCell className="font-medium text-sm">{n.recipient}</TableCell>
                        <TableCell className="text-sm text-muted-foreground max-w-[200px] truncate">{n.message}</TableCell>
                        <TableCell>
                          <Badge className={`border-0 gap-1 ${statusColors[n.status]}`}>
